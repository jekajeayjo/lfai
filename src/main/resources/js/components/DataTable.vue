...
<!--        тАБЛИЦА-->
        <v-data-table
                :items-per-page="options.perPaginationTable"
                dense
                no-data-text=""
                :headers="headers"
                :items="desserts"
...
<!--                    ></v-divider>-->
                    ...
                    <v-dialog v-model="dialog" max-width="500px">
                        ...
                        <v-card>
                            ...
                            <v-card-actions>
                                <v-spacer></v-spacer>
                                <v-btn color="red darken-1" text @click="close"><v-icon>backspace</v-icon></v-btn>
                                <v-btn color="blue" text @click="save"><v-icon>save</v-icon></v-btn>
                            </v-card-actions>
                        </v-card>
                    </v-dialog>
                </v-toolbar>
